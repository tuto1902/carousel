...
@endphp
<div class="flex m-16">
    <div x-data="carouselData()" x-init="init(@js($options)@if($autoplay == 'true'), {{ $autoplay }}, @js($autoPlayOptions)@endif)" class="relative max-w-xl" role="region" aria-roledescription="carousel">
        <!-- Slides Viewport -->
